...
var routes = [
    ...
    { path: 'loginuser', component: _login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] },
    { path: 'movies', canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]], component: _movies_movies_component__WEBPACK_IMPORTED_MODULE_4__["MoviesComponent"] },
...
module.exports = ".pricing-header{\r\n    background-color: rgb(255, 189, 8);\r\n    color: rgb(0, 0, 0);\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var ng_socket_io__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ng-socket-io */ "./node_modules/ng-socket-io/dist/index.js");
/* harmony import */ var ng_socket_io__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(ng_socket_io__WEBPACK_IMPORTED_MODULE_13__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                ng_socket_io__WEBPACK_IMPORTED_MODULE_13__["SocketIoModule"].forRoot(config)
            ],
            providers: [_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"], _auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"],
                {
...
var DataService = /** @class */ (function () {
    function DataService(_http, socket) {
        this._http = _http;
        this.socket = socket;
    }
    ...
    DataService.prototype.sendMessage = function (msg) {
        this.socket
            .emit("msg", msg);
    };
    ...
    DataService.prototype.sendData = function () {
        return this._http.get('http://localhost:3000/movies');
    };
    DataService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], ng_socket_io__WEBPACK_IMPORTED_MODULE_3__["Socket"]])
    ], DataService);
    return DataService;
}());
...
module.exports = ".alert{\r\n    width: 500px;\r\n    height: 50px;\r\n    text-align: center;\r\n    color: #ffffff;\r\n    background-color: rgb(23, 93, 155);\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div class=\"container\">\n    <div class=\"row\">\n        <div class=\"col-md-6\">\n            <input class=\"form-control\" type=\"text\" [(ngModel)]=\"display\" name=\"\" value=\"\"><br>\n            <button  class=\"btn btn-primary\" (click)=\"postData(display)\">Post data</button><br>   \n          <div class=\"alert alert-warning alert-dismissible fade show\" role=\"alert\" *ngIf=\"msg\">\n            <p>{{msg}}</p>\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n          </div>\n        </div>\n    </div>\n</div>"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.sendMsg = function (msg) {
        this._dataService.sendMessage(msg);
    };
    HomeComponent.prototype.postData = function (msg) {
        console.log(msg);
        this._dataService.sendData().subscribe(function (res) {
            console.log(res);
        });
        this._dataService.sendMessage(msg);
    };
...
var MoviesComponent = /** @class */ (function () {
    function MoviesComponent(_data) {
        this._data = _data;
    }
    MoviesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._data.getData().subscribe(function (result) {
            _this.res = result;
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(_auth, _router, _dataService) {
        this._auth = _auth;
        this._router = _router;
        this._dataService = _dataService;
...
module.exports = __webpack_require__(/*! C:\Users\sboyapal\Projects\Test\angular\src\main.ts */"./src/main.ts");
